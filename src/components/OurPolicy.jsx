...
import { faShirt, faMoneyBillWave, faRecycle, faStar } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className='bg-[#f5ece3] py-20 px-6'>
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='text-center group'>
            <div className='w-16 h-16 bg-[#3d2b1f] rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300'>
              <FontAwesomeIcon icon={faMoneyBillWave} className='w-8 h-8 text-[#fdf7f0]' />
            </div>
            <h3 className='text-xl font-semibold mb-3 text-[#3d2b1f]'>No Deposit Policy</h3>
            <p className='text-[#3d2b1f] opacity-80 text-sm leading-relaxed'>
              Rent stylish pieces with zero upfront deposits. Enjoy flexible, risk-free access to premium fashion without locking away funds.
            </p>
          </div>
