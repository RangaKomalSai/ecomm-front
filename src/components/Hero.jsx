...
import { faChevronLeft, faChevronRight, faStar, faBox, faLeaf, faHeart, faGem } from '@fortawesome/free-solid-svg-icons'
...
const Hero = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      tagline: "Choose better. Dress bold.",
      icon: faGem
    },
    {
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className='absolute left-4 sm:left-6 top-1/2 transform -translate-y-1/2 bg-[#3d2b1f]/90 hover:bg-[#3d2b1f] text-white w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110 shadow-xl backdrop-blur-sm z-20'
      >
