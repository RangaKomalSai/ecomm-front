...
const Navbar = () => {
  ...
  const { token, logoutUser, cart, wishlist, user, subscription, planLevel } =
  ...
  return (
    <div className="sticky top-0 z-50 flex items-center justify-between py-3 font-medium bg-white/95 backdrop-blur-sm text-[#3d2b1f] shadow-lg border-b border-[#e8dccf] w-screen -ml-[calc(50vw-50%)] px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]">
      <Link to="/" onClick={scrollToTop} className="flex items-center gap-3">
        <img
          src={assets.logo_iconb}
          className="h-8"
          alt="Logo Icon"
          draggable={false}
        />
        <img
          src={assets.logo_textb}
          className="h-6"
          alt="Logo"
          draggable={false}
        />
      ...
      <ul className="hidden sm:flex gap-4 text-sm md:text-sm lg:text-base text-[#3d2b1f]">
        <NavLink
          to="/"
          onClick={scrollToTop}
          className="flex flex-col items-center gap-1 hover:text-[#5a3c2c] transition-colors"
        >
          <p>HOME</p>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="group relative">
          ...
          {token && (
            <div className="group-hover:opacity-100 group-hover:visible opacity-0 invisible absolute dropdown-menu right-0 pt-4 transition-all duration-200 ease-in-out">
              <div className="bg-white border border-[#e8dccf] rounded-xl shadow-xl py-2 min-w-[220px] overflow-hidden">
                {/* User Info Header */}
                <div className="px-4 py-3 border-b border-[#e8dccf] bg-gradient-to-r from-[#f5ece3] to-[#fdf7f0]">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#3d2b1f] opacity-70 capitalize">
                        {planLevel} Plan
                      </p>
                    </div>
                  </div>
                ...
                <div className="py-2">
                  ...
                  >
                    <FontAwesomeIcon
                      icon={faUser}
                      className="w-4 h-4 text-[#3d2b1f] group-hover/item:text-[#5a3c2c] transition-colors"
                    />
                    <span className="text-sm text-[#3d2b1f] group-hover/item:text-[#5a3c2c] transition-colors">
                      My Profile
                    </span>
                  </div>
                  ...
                  >
                    <FontAwesomeIcon
                      icon={faSignOutAlt}
                      className="w-4 h-4 text-red-600 group-hover/item:text-red-700 transition-colors"
                    />
                    <span className="text-sm text-red-600 group-hover/item:text-red-700 transition-colors">
                      Logout
                    </span>
                  </div>
                </div>
        ...
        <Link to="/cart" onClick={scrollToTop} className="relative">
          ...
          />
          {getCartCount() > 0 && (
            <p className="absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-[#3d2b1f] text-[#fdf7f0] aspect-square rounded-full text-[8px]">
              {getCartCount()}
            </p>
          )}
        </Link>
      ...
      <div
        className={`absolute top-0 right-0 overflow-hidden bg-[#fdf7f0] transition-all duration-300 ${
          visible ? "w-full" : "w-0"
        }`}
      >
        <div className="flex flex-col text-[#3d2b1f] min-h-screen h-full">
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-[#e8dccf] bg-gradient-to-r from-[#f5ece3] to-[#fdf7f0]">
            ...
            <button
              ...
              className="p-2 hover:bg-[#e8dccf] rounded-full transition-colors"
            >
              <img
          ...
          <div className="flex-1 py-4 overflow-auto">
            <NavLink
              ...
              className="flex items-center gap-3 py-3 px-6 border-b border-[#e8dccf] hover:bg-[#e8dccf] transition-colors group/item"
            >
            ...
            <div className="border-t border-[#e8dccf] bg-white">
              ...
              <div className="py-2">
                <div
                  ...
                  className="flex items-center gap-3 px-6 py-3 cursor-pointer hover:bg-[#e8dccf] transition-colors group/item"
                >
                  <FontAwesomeIcon
                    icon={faUser}
                ...
                >
                  <FontAwesomeIcon
                    ...
                    className="w-4 h-4 text-[#3d2b1f]"
                  />
                  <span className="text-sm text-[#3d2b1f]">My Bookings</span>
                </div>
                ...
                >
                  <FontAwesomeIcon
                    ...
                    className="w-4 h-4 text-[#3d2b1f]"
                  />
                  <span className="text-sm text-[#3d2b1f]">Subscription</span>
                  {subscription?.isActive && (
                    <span className="ml-auto bg-green-500 text-white text-xs px-2 py-1 rounded-full">
                      Active
                    </span>
                ...
                <div
                  onClick={handleLogout}
                  className="flex items-center gap-3 px-6 py-3 cursor-pointer hover:bg-red-50 transition-colors group/item"
                >
                  <FontAwesomeIcon
                    icon={faSignOutAlt}
