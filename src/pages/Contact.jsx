          ...
          <div className='lg:w-1/2 flex flex-col gap-8'>
            ...
            <div className='bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300'>
              <div className='flex items-center gap-4 mb-6'>
                ...
                <h2 className='text-2xl font-bold text-[#3d2b1f]'>Our Store</h2>
              </div>
              <div className='space-y-4'>
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <p className='text-[#3d2b1f] opacity-80'>+91 99999 99999</p>
                </div>
                <div className='flex items-start gap-3'>
                  <FontAwesomeIcon icon={faEnvelope} className='w-5 h-5 text-[#8b4513] mt-1' />
                  <p className='text-[#3d2b1f] opacity-80'>admin@vesper.com</p>
                </div>
              </div>
            </div>
