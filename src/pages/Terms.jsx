...
const Terms = () => {
  const content = (
    <div>
      ...
      <h2 className='text-xl font-semibold mb-4 mt-8'>1. Acceptance of Terms</h2>
      ...
      <h2 className='text-xl font-semibold mb-4 mt-8'>3. Rental Terms</h2>
      <p className='mb-4 text-gray-700'>
      ...
      <h2 className='text-xl font-semibold mb-4 mt-8'>4. Payment Terms</h2>
      <p className='mb-4 text-gray-700'>
      ...
      <h2 className='text-xl font-semibold mb-4 mt-8'>5. Limitation of Liability</h2>
      <p className='mb-4 text-gray-700'>
      ...
      <h2 className='text-xl font-semibold mb-4 mt-8'>6. Contact Information</h2>
      <p className='mb-4 text-gray-700'>
        If you have any questions about these Terms of Service, please contact us at:
      </p>
      <p className='mb-2 text-gray-700'>Email: legal@vesper.com</p>
